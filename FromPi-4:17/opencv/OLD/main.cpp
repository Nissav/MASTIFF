...
int main()
{
    Mat object = imread( "/home/pi/opencv/sstock3.jpg", CV_LOAD_IMAGE_GRAYSCALE );
    ...
    //VideoCapture cap(0);
	Mat frame = imread( "/home/pi/opencv/photo.jpg", CV_LOAD_IMAGE_GRAYSCALE );
